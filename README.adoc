...
[source,shell]
----
curl  -Hx-rh-identity:`cat src/test/resources/rhid.txt` http://localhost:8080/api/policies/v1/policies
----
...
[source,shell]
----
curl  -Hx-rh-identity:`cat src/test/resources/rhid.txt` http://localhost:8080/api/policies/v1/policies?page=5
----
...
[source,shell]
----
curl  -Hx-rh-identity:`cat src/test/resources/rhid.txt` http://localhost:8080/api/policies/v1/facts
----
...
----
 curl -i -HContent-Type:application/json  \
         ...
         -d @src/test/resources/example-policy.json \
          http://localhost:8080/api/policies/v1/policies
----
...
OpenAPI spec of the API is available under http://localhost:8080/api/policies/v1/openapi.json
