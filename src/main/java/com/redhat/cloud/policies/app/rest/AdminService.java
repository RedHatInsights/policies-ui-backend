...
public class AdminService {
    ...
    public Response findOrphans() {
        Map<String, List<TriggerTenantTuple>> orphanedPolicies = new HashMap<>();
        List<TriggerTenantTuple> orphanedInDB = new ArrayList<>();
        List<TriggerTenantTuple> orphanedInEngine = new ArrayList<>();
            ...
            policies
                    .forEach(p -> {
                        try {
                            ...
                            orphanedInDB.add(new TriggerTenantTuple(p.customerid, p.id));
                        }
                    });
        }
        ...
        customersInDb
                .forEach(cid -> {
                    ...
                    triggers.forEach(t -> {
                        ...
                        if (pol == null) {
                            orphanedInEngine.add(new TriggerTenantTuple(cid, t.id));
                        }
                    });
                });
    ...
    public static class TriggerTenantTuple {
        String cid; // Tenant
        String tid; // TriggerId

        public TriggerTenantTuple(String customerId, String id) {
            this.cid = customerId;
            this.tid = id;
        }

        public TriggerTenantTuple(String customerid, UUID id) {
        ...
        public String toString() {
            final StringBuilder sb = new StringBuilder("TriggerTenantTuple{");
