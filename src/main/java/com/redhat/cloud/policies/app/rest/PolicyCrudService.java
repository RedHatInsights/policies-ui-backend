...
public class PolicyCrudService {
    ...
    private static final String MISSING_PERMISSIONS_TO_RETRIEVE_POLICIES = "Missing permissions to retrieve policies";
    private static final String MISSING_PERMISSIONS_TO_VERIFY_POLICY = "Missing permissions to verify policy";
    private static final String MISSING_PERMISSIONS_TO_UPDATE_POLICY = "Missing permissions to update policy";

    private static final String ERROR_STRING = "error";
    private static final String CTIME_STRING = "ctime";
