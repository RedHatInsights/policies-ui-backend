...
insert into policy (id, customerId, name, description, is_enabled, conditions, actions) values ('c49e92c4-764c-4163-9200-245b31933e94', '1234', '2nd policy', 'Another test', false, '"cpu" != "intel"','HOOK http://localhost:8080');
insert into policy (id, customerId, name, description, is_enabled, conditions, actions) values ('f36aa564-ffc8-48c6-a27f-31ddd4c16c8b', '1234', 'Detect Nice box', 'Test for os and arch', true, '"os_version" == "7.5" AND "arch" == "x86_64"', 'NOTIFY; EMAIL foo@acme.org');
insert into policy (id, customerId, name, description, is_enabled, conditions, actions) values ('cd6cceb8-65dd-4988-a566-251fd20d7e2c', '1234', '4th policy', 'Test for account2', true, '"cores" > 4','SLACK slack://foo.slack-com/#channel');
insert into policy (id, customerId, name, description, is_enabled, conditions, actions) values ('c49e92c4-dead-beef-9200-245b31933e94', '1234', '4th policy-2', 'Test for account2', true, '"cores" > 4','SLACK slack://foo.slack-com/#channel');
