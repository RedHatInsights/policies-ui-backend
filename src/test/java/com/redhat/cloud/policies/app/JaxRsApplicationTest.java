...
class JaxRsApplicationTest {
    ...
    @Test
    void shouldMatchPoliciesStatus() {
        String inputWithHttpTwoZero = "127.0.0.1 - - 09/Jun/2021:16:07:07 +0200 \"GET /api/policies/v1.0/status HTTP/2.0\" 200 46 \"-\" \"Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:88.0) Gecko/20100101 Firefox/88.0\"\n";
        assertTrue(Pattern.matches(FILTER_REGEX, inputWithHttpTwoZero.trim()));
    }

    @Test
    void shouldNotMatchPoliciesStatus() {
        String inputWithHttpTwoZero = "127.0.0.1 - - 09/Jun/2021:16:07:07 +0200 \"GET /api/policies/v2.0/status HTTP/2.0\" 200 46 \"-\" \"Mozilla/5.0 (X11; Fedora; Linux x86_64; rv:88.0) Gecko/20100101 Firefox/88.0\"\n";
        assertFalse(Pattern.matches(FILTER_REGEX, inputWithHttpTwoZero.trim()));
    }

    @Test
    void shouldNotMatchOpenApiEndpoint() {
        String input = "127.0.0.1 - - 10/Jun/2021:12:49:34 +0200 \"GET /api/policies/v1.0/openapi.json HTTP/1.1\" 200 26832 \"-\" \"Java/11.0.10\"\n";
        assertFalse(Pattern.matches(FILTER_REGEX, input.trim()));
    }
}